...
Zestawiamy ze sobą z jednej strony wyniki otrzymane przy użyciu pojedynczego węzła obliczeniowego z drugiej zaś wyniki głównego węzła obliczeniowego klastra mającego do dyspozycji 4 jednostki obliczeniowe, a zatem ma do dyspozycji około 4-krotnie większą liczbę ewaluacji funkcji, oraz pojedynczego węzła używającego GPU do przeprowadzenia dodatkowych obliczeń. Porównanie rezultatów wskazuje na nieco lepsze jakościowo rozwiązanie korzystające z obliczeń równoległych. Ogólnie jednak gorsze efekty uzyskane przez nasz program w porównaniu z najlepszymi algorytmami optymalizacyjnymi uwidaczniają słabsze działanie standardowego algorytmu PSO. 
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[width=0.8\textwidth,natwidth=610,natheight=642]{S3/pprldmany-single-%functions/pprldmany.pdf}
%\end{figure}

\subsection{Klaster (4 węzły obliczeniowe)}

%\begin{figure}[H]
%    \centering
%    \includegraphics[width=0.8\textwidth,natwidth=610,natheight=642]{C2/pprldmany-single-%functions/pprldmany.pdf}
%    \label{fig:poasdasd}
%\end{figure}

\subsection{Pojedynczy węzeł obliczeniowy z wykorzystaniem GPU}


\section{Interpretacja wyników}

Słabsze od optymalnych wyniki algorytmu PSO mogą wskazywać na to, że standardowa jego wersja nie sprawdza się w przypadku bardziej skomplikowanych funkcji. W celu poprawy rezultatów należałoby wprowadzić modyfikacje algorytmu takie jak np. opisana we wstępie hybrydyzacja z innymi algorytmami lub połączenie z innymi wersjami PSO.
