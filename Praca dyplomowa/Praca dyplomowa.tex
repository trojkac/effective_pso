...
\begin{figure}[H]
 ...
 \caption{Rysunek przedstawia kilka przykładowych topologii roju cząstek: (1) pełne sąsiedztwo, (2) pierścień, (3) topologia von Neumanna, (4) losowe sąsiedztwo. (Rysunek pochodzi z \cite{topologieRys}}
\end{figure}
...
\textbf{Hubert Rosiak} - Odpowiadał za stworzenie wrappera do platformy COCO. Brał udział w tworzeniu struktury węzła obliczeniowego. Zajmował się przeglądem i opisem znanych rezultatów i zastosowań oraz literatury dotyczącej PSO. Brał udział w opisywaniu części systemu działającej na CPU oraz w planowaniu, przeprowadzaniu oraz dokumentacji i opracowaniu wyników.\\
