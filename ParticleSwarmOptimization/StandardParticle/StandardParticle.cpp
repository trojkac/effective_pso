...
StandardParticle::StandardParticle(int dimensions): dimensions_(dimensions)
{
	personal_best_ = make_tuple(std::vector<double>(2), -std::numeric_limits<double>::infinity());
}

void StandardParticle::init_location()
{
...
void StandardParticle::init_velocity()
{
...
std::tuple<std::vector<double>, double> StandardParticle::update_personal_best(std::function<double(std::vector<double>)> function)
{
...
void StandardParticle::update_neighborhood(std::vector<Particle*> all_particles)
{
...
void StandardParticle::update_velocity()
{
...
void StandardParticle::translate()
{
