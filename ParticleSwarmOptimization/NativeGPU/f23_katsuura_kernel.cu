...
extern "C" {
                                      ...
                                      double* xopt, double* M, double* b, double fopt, double penalty)
    {
        ...
        if(wrapped_fitness_function(tempParticle1, dimensionsCount, xopt, M, b, fopt, penalty) <
           wrapped_fitness_function(tempParticle2, dimensionsCount, xopt, M, b, fopt, penalty))
        {
