...
extern "C" {
                                      ...
                                      double* xopt, double fopt, double penalty, double* M, double* b, double* ak, double* bk, double f0)
    {
        ...
        if(wrapped_fitness_function(tempParticle1, dimensionsCount, xopt, fopt, penalty, M, b, ak, bk, f0) <
           wrapped_fitness_function(tempParticle2, dimensionsCount, xopt, fopt, penalty, M, b, ak, bk, f0))
        {
