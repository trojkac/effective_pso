...
extern "C" {
                                      ...
                                      double* xopt, double fopt, double conditioning, double asymmetric)
    {
        ...
        if(wrapped_fitness_function(tempParticle1, dimensionsCount, xopt, fopt, conditioning, asymmetric) <
           wrapped_fitness_function(tempParticle2, dimensionsCount, xopt, fopt, conditioning, asymmetric))
        {
