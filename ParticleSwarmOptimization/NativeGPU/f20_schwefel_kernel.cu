...
extern "C" {
                                      ...
                                      double* xopt, double* M, double* b, double fopt, double* tmp1, double* tmp2, double seed)
    {
        ...
        if(wrapped_fitness_function(tempParticle1, dimensionsCount, xopt, M, b, fopt, tmp1, tmp2, seed) <
           wrapped_fitness_function(tempParticle2, dimensionsCount, xopt, M, b, fopt, tmp1, tmp2, seed))
        {
