...
void run()
{
    ...
    initialize_particles KERNEL_ARGS2(num_of_blocks, threads_per_block) (d_particles, d_velocities, d_personal_bests_locations, d_personal_bests_values, dim, nr_of_particles, d_neighbor_bests_locations, d_neighbor_bests_values);
    ...
    for(int i = 1; i <= iterations; i++)
    {
        ...
        actualize_bests KERNEL_ARGS2(num_of_blocks, threads_per_block) (d_particles, d_velocities, d_personal_bests_locations, d_personal_bests_values, dim, nr_of_particles, d_neighbor_bests_locations, d_neighbor_bests_values);
